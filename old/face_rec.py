...
def retrive_data(name):
    ...
    #retrive_df[['Name','Role']] = retrive_df['name_role'].apply(lambda x: x.split('@') if '@' in x else ['','']).apply(pd.Series)
    retrive_df[['Name','Role']] = retrive_df['name_role'].apply(lambda x: pd.Series(x.split('@')) if '@' in x else pd.Series(['', '']))
